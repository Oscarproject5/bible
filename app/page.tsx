      ...
      <section className="relative py-16 lg:pb-24 bg-gradient-to-br from-slate-50 via-blue-50 to-amber-50 overflow-hidden">
        ...
        <div className="block lg:hidden px-4 mb-8">
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-xl border border-blue-100/50 max-w-lg mx-auto">
            ...
            <p className="text-muted-foreground text-sm mt-3 font-semibold">- 1 Corinthians 13:4,8</p>
          </div>
        </div>
        ...
        <div className="block lg:hidden px-4 mb-8">
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-xl border border-amber-100/50 max-w-lg mx-auto">
            <h3 className="text-lg font-bold text-primary mb-4 flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-primary">Scripture Reading</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-primary">Group Discussion</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-primary">Prayer Circle</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-primary">Fellowship</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-primary">Life Application</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-primary">Refreshments</span>
              </div>
            </div>
          </div>
        </div>
